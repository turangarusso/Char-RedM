...
RegisterNetEvent('ruxo:chatAzione')
AddEventHandler('ruxo:chatAzione', function(id, message, name)

	if IsInProximity(id, 100) then
    --TriggerEvent('chat:addMessage', "[Azione]: "..message)
    TriggerEvent('chatMessage', '', { 255, 255, 255 }, "[Azione]: "..message)
...
RegisterNetEvent('ruxo:chatAnnuncio')
AddEventHandler('ruxo:chatAnnuncio', function(id, message, name)
  TriggerEvent('chatMessage', '', { 255, 255, 255 }, "[Annuncio]: "..message)
end)
...
RegisterCommand('azione', function(source, args, raw)
  ...
  TriggerServerEvent('ruxo:AzioneChat', myId, args, raw)

end)

RegisterCommand('annuncio', function(source, args, raw)
  local myId = GetPlayerServerId(PlayerId())
  TriggerServerEvent('ruxo:ChatAnnuncio', myId, args, raw)
